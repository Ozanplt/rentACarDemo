...
public class ColorManager implements ColorService {
    ...
    public Result add(CreateColorRequest createColorRequest) {
        ...
        return new SuccessResult(BusinessMessages.ColorMessage.COLOR_ADDED);
    ...
    public Result update(UpdateColorRequest updateColorRequest) {
        ...
        this.colorDao.save(color);
        return new SuccessResult(BusinessMessages.ColorMessage.COLOR_UPDATED);
    }

    @Override
    public Result delete(DeleteColorRequest deleteColorRequest) {
        this.colorDao.deleteById(deleteColorRequest.getId());
        return new SuccessResult(BusinessMessages.ColorMessage.COLOR_DELETED);
    }
